...
function CyberTerminalHero(props) {
    const { size, input, rootRef, reducedMotion, 
    // Screenshot
    screenshot = 'https://crazygl.com/samples/screenshot-dashboard-dark-2.avif', screenshotX = 0, screenshotY = 0, screenshotScale = 1.0, screenshotTilt = -8, screenEmissive = 0.6, 
    // Fragments
    fragmentCount = 22, commands, fragmentColor1 = '#56ffa0', fragmentColor2 = '#56e3ff', fragmentColor3 = '#ffb45a', fragmentSpeed = 0.3, 
    // Particles
    particleCount = 300, particleColor1 = '#56ffa0', particleColor2 = '#56e3ff', particleColor3 = '#ffb45a', particlePull = 0.4, 
    // Cursor trail
    cursorTrailEnabled = true, cursorTrailColor = '#56ffa0', cursorTrailLength = 24, 
    // Atmosphere
    haloColor = '#56ffa0', haloStrength = 0.4, bgColor = '#020410', gridStrength = 0.04, transparentBackground = false, 
    // Motion
    parallaxStrength = 0.4, } = props;
    ...
    const gridLayer = React.useMemo(() => {
        if (gridStrength <= 0 || transparentBackground)
            return null;
        ...
        return (_jsx("div", { "aria-hidden": "true", className: "crazygl-cyber-terminal-grid", style: {
                position: 'absolute',
                inset: 0,
                backgroundImage: url,
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("crazygl-stage", { style: {
                    position: 'absolute',
                    inset: 0,
                    zIndex: 0,
                    overflow: 'hidden',
                    background: stageBg,
                }, children: [gridLayer, mounted ? (_jsx(React.Suspense, { fallback: null, children: _jsx(TerminalStage, { rootRef: rootRef, size: size, input: input, reducedMotion: !!reducedMotion, screenshot: screenshot, screenshotX: screenshotX, screenshotY: screenshotY, screenshotScale: screenshotScale, screenshotTilt: screenshotTilt, screenEmissive: screenEmissive, fragmentCount: fragmentCount, commands: commands, fragmentColor1: fragmentColor1, fragmentColor2: fragmentColor2, fragmentColor3: fragmentColor3, fragmentSpeed: fragmentSpeed, particleCount: particleCount, particleColor1: particleColor1, particleColor2: particleColor2, particleColor3: particleColor3, particlePull: particlePull, cursorTrailEnabled: !!cursorTrailEnabled, cursorTrailColor: cursorTrailColor, cursorTrailLength: cursorTrailLength, haloColor: haloColor, haloStrength: haloStrength, parallaxStrength: parallaxStrength }) })) : null] }), _jsx("crazygl-content", { style: {
                    position: 'absolute',
                    inset: 0,
                    display: 'flex',
                    alignItems: 'center',
                    ...
                    pointerEvents: 'none',
                    padding: '0 6vw',
                }, children: _jsx("div", { className: "crazygl-cyber-terminal-content", children: content.node }) })] }));
}
...
export default function CyberTerminal(props) {
    return _jsx(CrazyGLWrapper, { hero: CyberTerminalHero, metadata: metadata, ...props });
}
export { metadata };
